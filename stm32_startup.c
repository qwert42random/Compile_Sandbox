...
extern uint32_t _etext;		// End of .text section. Address of values of initialised variables.
extern uint32_t _sdata;		// Address static variables are stored at.
extern uint32_t _edata;		// End of static variables memory.
extern uint32_t _la_data;	// 

extern uint32_t _sbss;		// Start address of the static variables.
extern uint32_t _ebss;		// End address of the static variables.
...
void Reset_Handler(void)
{
	...
	// Initialise the .bss to zero in SRAM.
	
	// Call init functions to intialise standard libraries being used.
